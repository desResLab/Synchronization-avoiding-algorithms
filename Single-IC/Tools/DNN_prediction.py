...
from Dis_training.Multi_step_ResNet import *
...
def Dis_prediction(width,d0, Dirichlet):
	...
	data_save = 'Tools/Trained_model_overkill/Trained-time.pth'

	model = ResNet_block_4steps(num_input,num_neu,num_output)
